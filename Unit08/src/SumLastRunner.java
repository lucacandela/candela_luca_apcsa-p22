...
public class SumLastRunner
{
	public static void main( String args[] )
	{
		...
		System.out.println(RaySumLast.go(new int[]{-111,1,2,3,9,11,20,1}));
		System.out.println(RaySumLast.go(new int[]{9,8,7,6,5,4,3,2,0,-2,6}));
		System.out.println(RaySumLast.go(new int[]{12,15,18,21,23,1000}));
		System.out.println(RaySumLast.go(new int[]{250,19,17,15,13,11,10,9,6,3,2,1,0}));
